...
const CreatePost = () => {
    ...
    // i dont understand this part why ... (spread out the entire form?)
    ...
    const generateImage = async () => {
        if(form.prompt){
            try{
                ...
                const response = await fetch('https://dalle2u.onrender.com/api/v1/dalle',{
                    method: 'POST',
                    headers:{
                        'Content-Type': 'application/json',
                    },
            ...
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-5">
                    <FormField
                        ...
                        type="text"
                        name="name"
                        placeholder="Vernon Hansol Chwe"
                        value={form.name}
                    ...
                    <FormField
                        ...
                        type="text"
                        name="prompt"
                        placeholder="An anime character crying"
                        value={form.prompt}
                        handleChange={handleChange}
                        isSurpriseMe
                ...
                <div className="mt-10">
                    <p className="mt-2 text-[#666e75] text-[14px]">
                        Once you generated the image, you can share it with others
                    </p>
